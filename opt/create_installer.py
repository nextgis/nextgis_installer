...
repka_repositories = [
    ...
    {'package': 'py_frozenlist', 'version': '1.5.0'},
    {'package': 'py_multidict', 'version': '6.1.0'},
    {'package': 'py_yarl', 'version': '1.15.2'},
...
repositories_not_stored = [
    {'package': 'py_exifread', 'version': '3.5.1'},
    {'package': 'py_cycler', 'version': '0.12.1'},
    {'package': 'py_parsing', 'version': '3.1.4'},
    {'package': 'py_contextlib', 'version': '21.6.0'},
    {'package': 'py_future', 'version': '1.0.0'},
    {'package': 'py_requests', 'version': '2.32.4'},
    {'package': 'py_pytz', 'version': '2025.2'},
    {'package': 'py_nose', 'version': '0.15.1'},
    {'package': 'py_jinja', 'version': '3.1.6'},
    {'package': 'py_httplib', 'version': '0.31.0'},
    {'package': 'py_ows', 'version': '0.31.0'},
    {'package': 'py_dateutil', 'version': '2.9.0'},
    {'package': 'py_pygments', 'version': '2.19.2'},
    {'package': 'py_six', 'version': '1.17.0'},
    {'package': 'py_urllib3', 'version': '2.2.3'},
    {'package': 'py_idna', 'version': '3.10'},
    {'package': 'py_chardet', 'version': '5.2.0'},
    {'package': 'py_certifi', 'version': '2025.8.3'},
    {'package': 'py_geojson', 'version': '3.2.0'},
    {'package': 'py_tqdm', 'version': '4.67.1'},
    {'package': 'py_beautifulsoup', 'version': '4.13.5'},
    {'package': 'py_geographiclib', 'version': '2.1'},
    {'package': 'py_soupsieve', 'version': '2.7'},
    {'package': 'py_setuptools', 'version': '75.3.2'},
    {'package': 'py_tinydb', 'version': '4.8.2'},
    {'package': 'py_attrs', 'version': '25.3.0'},
    {'package': 'py_async_timeout', 'version': '5.0.1'},
    {'package': 'py_aiosignal', 'version': '1.3.1'},
    {'package': 'py_typing_extensions', 'version': 'latest'},
    {'package': 'py_propcache', 'version': '0.2.0'},
    {'package': 'py_aiohappyeyeballs', 'version': '2.4.4'},
]
