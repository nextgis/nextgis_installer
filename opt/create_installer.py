...
def create_installer():
    ...
    if sys.platform == 'darwin':
        ...
        run_shell('security unlock-keychain -p {} login.keychain && security import ./dev.p12 -k login.keychain -P \"\" -A && codesign --deep --force --verify --verbose --sign \"{}\" {}'.format(args.keychain_password, mac_sign_identy, os.path.join(repo_target_path, 'nextgis-setup.app')))
